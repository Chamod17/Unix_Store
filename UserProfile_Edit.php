...
$Squery1="SELECT *FROM usertable where email='$email' ";
  // Error Correction --- table name
if($result1 = mysqli_query($con, $Squery1)) {
  echo "";
}
else{
...
$code=$userRow["postalcode"];
$status=$userRow["status"];
$address=$userRow["address"];
$contry=$userRow["country"];
...
<head>
    ...
    <link rel="stylesheet" href="Styles/UserProfile_Edit.css">

    <title>UserProfile_Edit</title>
...
<div style="text-align: center; background-color: bisque;  font-family: 'georgia';">
    <br>
      <h1>Welcome to Edit User Profile </h1>
     <br> 
  </div>
  <br><br><br> 
                ...
                <div class="col-lg-8">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form action="UserProfile.php" method='POST'>   <!-- =============Error============-->
                            ...
                            <div class="row mb-3">                         <!-- Details-->
                                ...
                                <div class="col-sm-9 text-secondary">
                                    <input type="text" class="form-control" name="name1" <?php echo' value="'.$name.'"' ?>>
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9 text-secondary">
                                    <input type="text" class="form-control" name="phone" <?php echo' value="'.$telephone.'"' ?>>
                                </div>
                            </div>
                            <div class="row mb-3">
                                <div class="col-sm-3">
                                ...
                                <div class="col-sm-9 text-secondary">
                                    <input type="text" class="form-control" name="address1" <?php echo' value="'.$address.'"' ?>>
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9 text-secondary">
                                    <input type="text" class="form-control" name="code" <?php echo' value="'.$code.'"' ?>>
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9 text-secondary">
                                    <input type="text" class="form-control" name="country" <?php echo' value="'.$contry.'"' ?>>
                                </div>
                            </div>
...
if(isset($_POST['update'])){
    ...
    $sql1w="UPDATE usertable SET username='$_POST[username]', name='$_POST[name1]', email='$_POST[email]', password='$_POST[password1]',address='$_POST[address]',country='$_POST[country]',telephone='$_POST[phone]', postalcode='$_POST[code]' WHERE email='$email'";
    $qu_run=mysqli_query($con,$sql1w);
   
    if($qu_run){
        echo'<script type"teaxy/javascript"> alter ("Data Update")</script>';
}
    else{

        echo'<script type"teaxy/javascript"> alter ("Data Not Update")</script>';
}
