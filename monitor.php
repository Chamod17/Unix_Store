...
<!-- Item category and selection buttons -->
    ...
    <div class="col-md-10">
            ...
            <a href="newarrivals.php?i=monitors"><button type="button" class="btn btn-outline-warning" onclick="newarr()" class="common_selector newarr" name="newarr">New Arrivals</button></a>
    ...
    <!-- <div class="list-group">
     ...
     <?php
                    ...
                    $query = "SELECT DISTINCT(Brand) FROM products WHERE Category ='monitors'  ";
     ...
     <h3>Resolution</h3>
     <?php
                    $query = "SELECT DISTINCT(Spec1) FROM products WHERE Category ='monitors' ";
                    ...
                    ?>
                    <div class="list-group-item checkbox">
                        <label><input type="checkbox" class="common_selector storage" value="<?php echo $row['Spec1']; ?>"  > <?php echo $row['Spec1']; ?></label>
                    </div>
                    <?php
                    }
                    ?> 
