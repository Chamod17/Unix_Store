...
{
 $query = "SELECT * FROM products WHERE Category = 'laptop' ";
 ...
 if(isset($_POST["processor"]))
 {
  ...
  $query .= "AND Spec1 IN('".$processor_filter."')
  ";
   
 }
 if(isset($_POST["newarr"]))
 {
  $processor_filter = implode("','", $_POST["newarrr"]);
  $query .= " ORDER BY Date Limit 20";
  ...
  foreach($result as $row)
  {
   ...
   <div class="col-xs-12 col-sm-4 col-lg-3">
    ...
    '. $row['Spec2'] .' </p></td></tr>       
       ...
       <a href="preview.php?i='.$row['ID'].'"><button type="button" onclick="add_to"class="btn btn-outline-primary" style="align:center; class="common_selector add_to_cart" name="add_to_cart"">View item</button></a>
       </div></td>
       </tr>     
