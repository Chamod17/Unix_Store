...
<!-- Item category and selection buttons -->
    ...
    <div class="col-md-10">
            ...
            <a href="newarrivals.php?i=motherboard"><button type="button" class="btn btn-outline-warning" onclick="newarr()" class="common_selector newarr" name="newarr">New Arrivals</button></a>
            <a href="sales.php"><button type="button" class="btn btn-outline-dark">Special Offers %</button></a>
    </div>
</div>
    <!-- Page Content -->
    ...
    <!-- <div class="list-group">
     ...
     <?php
                    ...
                    $query = "SELECT DISTINCT(Brand) FROM products WHERE Category ='motherboard'  ";
