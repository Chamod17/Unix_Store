 ...
 if($total_row > 0)
 {
  foreach($result as $row)
  {
   ...
   <div class="col-xs-12 col-sm-4 col-lg-3">
    ...
    <div style="border:5px solid #ccc; align:center; border-radius:0px; overflow: hidden; padding:16px; margin-bottom:16px; height: auto;;  background-image: linear-gradient(White,LightGray)">
     <table>
        <tr>
